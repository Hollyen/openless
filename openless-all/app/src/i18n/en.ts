...
export const en: typeof zhCN = {
  ...
  style: {
    ...
    pack: {
      ...
      runtimeScreenContextTitle: 'Screen context block',
      runtimeScreenContextDesc: 'From OCR of current screen',
      runtimeScreenContextEmpty: 'Not added in the current preview.',
  ...
  settings: {
    ...
    ocr: {
      ...
      enableLabel: 'Enable screen context',
      enableHint: 'Capture the current screen at the start of each dictation and inject recognized text as polish context.',
      providerLabel: 'OCR provider',
      providerHint: 'Choose a local OCR engine. RapidOCR uses ONNX models with better Chinese accuracy; WinRT OCR is built into Windows 10/11 but Chinese depends on installed language packs.',
      modelsBaseDirLabel: 'Model storage directory',
      downloadMirrorLabel: 'Download mirror prefix',
      downloadMirrorHint: 'Leave empty to use the official GitHub URL. For a mirror, enter the release directory prefix (the app appends /<model-file>.onnx automatically), e.g. https://mirror.example.com/rapidocr/v2.0.0',
      downloadModel: 'Download models',
      cancelDownload: 'Cancel download',
      deleteModel: 'Delete models',
      downloadCompleted: 'Models downloaded',
      testRecognition: 'Test current screen OCR',
      testResult: 'Recognized text',
      noTextRecognized: 'No text recognized',
      screenRecordingDenied: 'macOS screen recording permission is not granted. Go to System Settings → Privacy & Security → Screen Recording, enable OpenLess, then fully quit and relaunch the app.',
      winrtLanguageMissing: 'WinRT OCR cannot create a Chinese recognition engine. Install the Chinese OCR language pack: Settings → Time & Language → Language & Region → Chinese → Language options → Optional features → Optical character recognition (OCR).',
      winrtLanguagePackHint: 'Requires the system Chinese OCR language pack',
